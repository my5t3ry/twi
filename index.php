...
header,main,footer{display:block;width:80vw;margin:1.2em auto;}
nav{display:block;text-align:center;}
p{margin:0;padding:.7em 1vw;}
main p{border-radius:1.2em;}
/* COLORS */
html{background:#241f1c;color:#ffefdc;}
main p:nth-child(odd){background:#ffefdc;color:#241f1c;}
a{color:#ffcd88;-webkit-transition:color .3s;transition:color .3s;}
a:hover,.tag{color:#ff935a;}
main p:nth-child(odd) a,p:nth-child(odd) .tag{color:#764300;}
main p:nth-child(odd) a:hover{color:#a10000;}
svg{fill:#ffefdc;}
/* TYPO */
body{font-family:monospace;}
time{font-size:small;}
pre{font: 10px/5px monospace;}
footer{text-align:center;}
/* LINK */
a{text-decoration:none;border-bottom:1px dotted currentColor;}
header a,nav a[rel=index]{border-bottom:none;}
/* SVG */
nav a[rel=index] svg{border-bottom:none;position:relative;top:.7em;width:24px;height:24px;}
header svg:first-of-type{width:55px;height:55.5px;}
header svg:last-of-type{width:355px;height:55.5px;}
@media (max-width:1100px){header svg:first-of-type{width:41.25px;height:40.875px}header svg:last-of-type{width:266.25px;height:40.875px}}
@media (max-width:850px){header svg:first-of-type{width:27.5px;height:27.75px}header svg:last-of-type{width:177.5px;height:25.75px}}
@media (max-width:272px){header svg{position:relative;top:0;}header svg:first-of-type{left:calc((100vw - 27.5px - 4rem) / 2);}header svg:last-of-type{left:calc((100vw - 177.5px - 4rem) / 2);}header h2{font-size:small;}}
        </style>
    ...
    <body>
        ...
        <nav><a rel="index" href="<?php print $index_url; ?>">
            <svg viewBox="0 0 36 36">
                ...
                <title><?php print $home ?></title><defs><?php print $home ?></defs>
                ...
                <?php ($lang === "fr") ? $tattr="fichier txt pour twtxt" : $tattr="twtfile for twtxt"; $twtfile=basename($twturl); ?>
        </a>&nbsp;&bullet; <a href="<?php print $twturl; ?>" rel="download" title="<?php print $tattr; ?>"><?php print $twtfile; ?></a></nav>
        </aside>
        <main>
<?php
$getfile=file_get_contents($twtfile);
if($reverse === true){
